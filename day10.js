...
// Tasks/Activities:
    // Activity 1: Basic Event Handling
        // Task 1: Add a click event listener to a button that changes the text content of a paragrap.
    ...
    // Activity 4: Form Events
        // Task 7: Add a submit event listener to a form that prevents the default submission and logs the form data to teh console.
        // Task 8: Add a change event listerner to a select dropdown that displays the selected values in a paragraph.
